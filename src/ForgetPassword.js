...
import { Modal, Button, Navbar, Form, InputGroup, Container, Row } from 'react-bootstrap';
...
export default class ForgetPassword extends Component {
  ...
  handleChange(event) {
    ...
    console.log(value)
    if ((!isNaN(parseFloat(value[value.length - 1])) || value === "") && (value.length < 10)) {
    ...
    return (
      <>
        ...
        <Modal.Dialog className="mt-5">
          <Modal.Header>
            <Modal.Title>Znajdź swoje konto</Modal.Title>
          </Modal.Header>

          <Modal.Body>
            <p>Wprowadź adres numer telefonu komórkowego, aby wyszukać swoje konto.</p>
            <input name="phone" value={this.state.phone} type="text" className="form-control" placeholder="Numer telefonu komórkowego" onChange={this.handleChange} />
          </Modal.Body>
